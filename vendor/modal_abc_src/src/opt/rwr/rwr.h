...
extern int g_TotalComparisons;
extern int g_CorrectPredictions;
...
extern float             Rwr_NodeRewriteP( Rwr_Man_t * p, Cut_Man_t * pManCut, Abc_Obj_t * pNode, int fUpdateLevel, int fUseZeros, int fPlaceEnable, int fSimple, int fCLustering );
extern float             Rwr_NodeRewriteExh( Rwr_Man_t * p, Cut_Man_t * pManCut, Abc_Obj_t * pNode, int fUpdateLevel, int fUseZeros, int fPlaceEnable, Abc_Frame_t * pAbcLocal );
