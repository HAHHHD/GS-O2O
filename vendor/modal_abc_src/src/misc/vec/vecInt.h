...
// static int Vec_IntSortCompare1( const void * pp1, const void * pp2 )
// {
//     const int v1 = *(const int *)pp1;
//     const int v2 = *(const int *)pp2;

//     if ( v1 < v2 ) return -1;
//     if ( v1 > v2 ) return 1;

//     // 2. Values are equal! Break the tie using their location in memory.
//     // This makes the sort "Stable" and consistent across all platforms.
//     if ( pp1 < pp2 ) return -1;
//     if ( pp1 > pp2 ) return 1;

//     return 0; // Absolute requirement for stability of the algorithm
// }
...
// static int Vec_IntSortCompare2( const void * pp1, const void * pp2 )
// {
//     const int v1 = *(const int *)pp1;
//     const int v2 = *(const int *)pp2;
