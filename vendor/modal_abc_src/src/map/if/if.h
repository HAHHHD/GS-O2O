...
struct If_Par_t_
{
    ...
    // *** Modification ***
    int                nExAreaIters;   // the number of iterations of area recovery
    // *** Modification ***
...
struct If_Obj_t_
{
    ...
    // *** Modification ***
    int                nRefsM;        // the number of references used in extended area recovery
    int                activated;     // the state of a node during extended area recovery
    int                nRoots;        // the number of roots after the last mapping
    // *** Modification ***
...
// *** Modification ***
extern void            If_CutAreaDerefM( If_Man_t * p, If_Cut_t * pCut );
extern void            If_CutAreaRefM( If_Man_t * p, If_Cut_t * pCut );
extern void            If_CutAreaDerefM_Once( If_Man_t * p, If_Cut_t * pCut );
extern void            If_CutAreaEdgeRefM( If_Man_t * p, If_Cut_t * pCut, double * area, double * edge );
extern void            If_CutAreaEdgeDerefM( If_Man_t * p, If_Cut_t * pCut, double * area, double * edge );
extern void            If_CutAreaEdgeDerefedM( If_Man_t * p, If_Cut_t * pCut, double * area, double * edge );
// *** Modification ***
/*=== ifDec.c =============================================================*/
