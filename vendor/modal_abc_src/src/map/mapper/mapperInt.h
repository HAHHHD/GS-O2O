...
{   
    ...
    int                 nRefActM[3];
    int                 nRoots[3];     // estimated fanout for current covering phase, neg and pos and sum
    int                 activated[3];
...
extern float             Map_CutGetHPWLFlow( Map_Node_t * pNode, Map_Cut_t * pCut, int fPhase );
...
//**************************
extern float             Map_CutGetAreaRefedM( Map_Cut_t * pCut, int fPhase );
extern float             Map_CutGetAreaDerefedM( Map_Cut_t * pCut, int fPhase );
// extern float             Map_CutGetAreaDerefedM( Map_Man_t * p, Map_Cut_t * pCut, int fPhase );
extern float             Map_CutRefM( Map_Cut_t * pCut, int fPhase );
extern float             Map_CutRefM_rec( Map_Cut_t * pCut, int fPhase, Vec_Ptr_t * vTmp, int limit );
extern float             Map_CutDerefM( Map_Cut_t * pCut, int fPhase );
extern void              Map_CutRefM_v( Map_Cut_t * pCut, int fPhase );
extern void              Map_CutDerefM_v( Map_Cut_t * pCut, int fPhase );
extern void              Map_CutDerefM_once( Map_Cut_t * pCut, int fPhase );
//**************************
