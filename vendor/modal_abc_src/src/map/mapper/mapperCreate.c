...
void            Map_NodeSetAigPos( Map_Node_t * p, Abc_Obj_t * pAig )            { p->xPos = pAig->xPos; p->yPos = pAig->yPos; }
;
...
***********************************************************************/
Map_Man_t * Map_ManCreate( int nInputs, int nOutputs, int fVerbose, int fModified, int fHPWL )
{
    Map_Man_t * p;
    int i;
