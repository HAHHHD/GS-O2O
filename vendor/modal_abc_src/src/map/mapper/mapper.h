...
/*=== mapperCreate.c =============================================================*/
//**************** 
extern Map_Man_t *     Map_ManCreate( int nInputs, int nOutputs, int fVerbose, int fModified, int fHPWL );
//**************** 
...
extern void            Map_NodeSetAigPos( Map_Node_t * p, Abc_Obj_t * pNode );
