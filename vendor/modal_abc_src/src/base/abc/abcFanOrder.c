...
// /* Tie-breaker so qsort sees a total order; avoids unspecified order of equal cubes. */
// static int Abc_NodeCompareCubesTieBreak( char ** pp1, char ** pp2 )
// {
//     if ( pp1 < pp2 ) return -1;
//     if ( pp1 > pp2 ) return  1;
//     return 0;
...
// int Abc_NodeCompareCubes1( char ** pp1, char ** pp2 )
// {
//     int c = strcmp( *pp1, *pp2 );
//     if ( c != 0 ) return c;
//     return Abc_NodeCompareCubesTieBreak( pp1, pp2 );
// }
// int Abc_NodeCompareCubes2( char ** pp1, char ** pp2 )
// {
//     char * pStr1 = *pp1;
