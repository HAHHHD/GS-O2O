...
Abc_Obj_t * Abc_NtkCreateObj( Abc_Ntk_t * pNtk, Abc_ObjType_t Type )
{
    ...
    pObj->rawPos = 1;
    // Terminals are fixed
    if ( Type == ABC_OBJ_PI || Type == ABC_OBJ_PO || Type == ABC_OBJ_CONST1 )
        pObj->rawPos = 0;
    pObj->marked = 0;
    // *********************************
...
Abc_Obj_t * Abc_NtkDupObj( Abc_Ntk_t * pNtkNew, Abc_Obj_t * pObj, int fCopyName )
{
    ...
    // *********************************
    pObjNew->isRoot = pObj->isRoot;
    pObjNew->rawPos = pObj->rawPos;
    pObjNew->xPos = pObj->xPos;
    pObjNew->yPos = pObj->yPos;
    // *********************************
